...
<head>
    ...
    <style>
        ...
        .card {
            ...
            padding: 60px; /* Aumenta el tamaño del padding para hacer la tarjeta más grande */
            text-align: center;
        }
...
if (isset($_GET['pokemon'])) {
    ...
    echo "<img src='{$pokemonDetails['sprites']['front_default']}' alt='{$pokemonDetails['name']} style='width: 50%;'>";
